...
local theme_file = theme_dir .. "/hidpi-theme.lua"
...
local cur_day_month = " <span size=\"xx-large\" "
                   .. "rise=\"-5000\" "
                   .. "color=\""..beautiful.blue .."\">%d、</span>"
local cur_month = " <span size=\"xx-large\" "
               .. "rise=\"-5000\" "
               .. "color=\""..beautiful.yellow.."\">%m、</span>"
local cur_day_week = " <span size=\"xx-large\" "
                  .. "rise=\"-5000\" "
                  .. "color=\""..beautiful.green.."\">%w、</span>"
local cur_hour = " <span size=\"xx-large\" "
              .. "rise=\"-5000\" "
