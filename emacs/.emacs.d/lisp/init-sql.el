...
;; Se my answer to https://emacs.stackexchange.com/questions/657/why-do-sql-mode-and-sql-interactive-mode-not-highlight-strings-the-same-way/673
...
If the region is not active, uses the current paragrap, as per
`sql-send-paragraph'.

Connection infromation is taken from the special sql-* variables
